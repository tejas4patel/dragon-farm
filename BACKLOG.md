...
| F3 | Delete and archive runs from the Monitor panel | done | `dragon_archive_run()`/`dragon_unarchive_run()`/`dragon_delete_run()`; Monitor panel gets Archive, Delete (with confirmation), a "Show archived" toggle, and Restore. |
