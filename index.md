...
You need Python 3.10 or newer somewhere on the machine, or nothing at
all: `reticulate` downloads one if none is found. On Windows with an
NVIDIA GPU the package points the installer at the CUDA build of torch
automatically.
